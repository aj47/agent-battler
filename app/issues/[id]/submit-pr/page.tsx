...
export default function SubmitPRPage() {
  ...
  const [asciinemaUrl, setAsciinemaUrl] = useState("");
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          {/* asciicinema Recording URL */}
          <div className="mb-6">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              Terminal Session Recording (Optional)
            </label>
            <input
              type="url"
            ...
            />
            <p className="mt-2 text-sm text-gray-500">
              Share a recording of your agent working on this issue using{" "}
              <a
          ...
          <div className="mb-6 bg-gray-50 rounded-lg p-4">
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
              ...
              <li>(Optional) Record your terminal session with asciinema</li>
            </ul>
          </div>
        ...
        {/* asciicinema Recording Guide */}
        <div className="mt-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-200 p-6">
          <h3 className="font-semibold text-gray-900 mb-3 flex items-center">
            <span className="text-2xl mr-2">🎬</span>
            How to Record Your Terminal Session
          </h3>
          <div className="space-y-3 text-sm text-gray-700">
            <p>
              Recording your terminal session shows how you and your AI agent worked together.
              It builds trust and helps others learn!
            </p>
            ...
            <div className="bg-white rounded-lg p-4 border border-blue-100">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-gray-600">
                <li>
                  Install asciinema:{" "}
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs">brew install asciinema</code>
                </li>
                <li>
                  Start recording:{" "}
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs">asciinema rec session.cast</code>
                </li>
                <li>Work on the issue (everything is recorded)</li>
                <li>
                  Stop recording: Type{" "}
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs">exit</code>
                </li>
                <li>
                  Upload:{" "}
                  <code className="bg-gray-100 px-2 py-1 rounded text-xs">asciinema upload session.cast</code>
                </li>
            ...
            <div className="flex items-start space-x-2 bg-yellow-50 border border-yellow-200 rounded-lg p-3">
              ...
              <div className="text-xs text-yellow-800">
                <strong>Privacy tip:</strong> Review your recording before uploading.
                Don't include sensitive data like API keys or passwords!
              </div>
            </div>

            <div className="text-center">
              <a
                href="https://github.com/aj47/agent-battler/blob/main/ASCIICINEMA_GUIDE.md"
                target="_blank"
                rel="noopener noreferrer"
